...
Convert floating-point weights to fixed-point format

Generate .mem files used by RTL and CUDA implementations

These .mem files allow the same trained model to run across all platforms.

Fixed-Point Arithmetic

Hardware accelerators typically avoid floating-point operations due to complexity and power cost.
